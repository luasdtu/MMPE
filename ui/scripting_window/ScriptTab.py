from MyQt import QtGui, Qsci, QtCore
from MyQt.QtCore import Qt
from MyQt.QtGui import QMessageBox, QTextEdit, QGridLayout, QWidget
...
#                    pass
    ...
    def get_script(self):
        return str(self.editor.text()).strip()
