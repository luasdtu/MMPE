...
import sys
import os
from functions.inspect_ext import argument_string
...
""" % (func_body_source(init, 4), func_source(f, 4), fname, func_body_source(fini, 4), seq)
        ...
        if fname not in self.seq_runner_modules:
            ...
            self.seq_runner_modules[fname] = reload(self.seq_runner_modules[fname])
...
print parmap(task, range(10), init=init, fini=fini, no_processors=2)
        """
