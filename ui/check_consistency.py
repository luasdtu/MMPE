...
from ui.qt_ui import QtOutputUI, QtStatusUI
from ui.text_ui import TextUI, TextOutputUI, TextStatusUI
from MyQt import QtGui

def compare(a, b):
    methods = lambda obj : set([m for m in dir(obj) if not m.startswith('_')])
