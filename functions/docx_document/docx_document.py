...
def prefered_graphic_format():
    if vector_graphics_support():
        return "pdf"
    else:
        return "png"
...
#            self.body.append(caption("Figure", caption_text))
    ...
    def append_table(self, lst_of_lst, heading=True, colw=None, cwunit='dxa', tblw=0, twunit='auto',
    ...
    def append_markdown(self, s):
        ...
        for l in s.split("\n"):
            ...
            if l.startswith("#"):
                ...
                self.append_paragraph(zip(text_lst, style_lst))
            else:
                self.n(l)
