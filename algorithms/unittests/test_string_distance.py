...
from algorithms.string_distance import SmartDistance
from algorithms.string_matching import SmartMatch
from algorithms.test import score_dict_cython
...
class Test(unittest.TestCase):
    ...
    def testStringMatching4(self):
        w = 'Mads'
        print [SmartDistance().get_score(w, l) / len(w) for l in ['mads', 'mdsa', 'mds']]
#
#
