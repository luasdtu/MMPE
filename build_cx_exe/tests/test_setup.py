...
class Test_exe(unittest.TestCase):
    ...
    def test_setup(self):
        build_cx_exe.build_cx_exe.write_setup("name", "version", "description", "author")
    ...
    def test_setup_matplotlib(self):
        build_cx_exe.build_cx_exe.write_setup("name", "version", "description", "author", modules=[build_cx_exe.MATPLOTLIB])
        with open('setup.py') as fid:
            lines = fid.readlines()
