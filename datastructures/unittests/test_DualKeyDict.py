...
from datastructures.dual_key_dict import DualKeyDict
...
class Test(unittest.TestCase):
    ...
    def testget(self):
        ...
        self.assertRaisesRegexp(ValueError, "More objects associated by key, 'two'. Use 'get' function instead", self.dkd.__getitem__, ("two"))
    ...
    def test_add_not_unique_key(self):
        self.assertRaisesRegexp(KeyError, "Key '3' already exists in dict", self.dkd.add, (Example(3, "three")))
    ...
    def test_get_list(self):
        ...
        self.assertRaisesRegexp(ValueError, "More objects associated by key, 'two'", self.dkd.get, "two", multiple_error=True)
