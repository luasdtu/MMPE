...
class Test_cython_compile(unittest.TestCase):
    ...
    def test_compiled_package(self):
        clean("pack/test_cython_compile_CyTest")
        import pack.cytest_module
        self.assertTrue(pack.cytest_module.CyTest(3)[0])
        self.assertEqual(pack.cytest_module.CyTest(3)[1], 6)
